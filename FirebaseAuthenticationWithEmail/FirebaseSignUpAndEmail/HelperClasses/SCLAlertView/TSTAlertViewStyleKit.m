...
// ------------------------------------
@implementation TSTAlertViewStyleKit
...
+ (UIImage*)imageOfCheckmark
{
    ...
    [TSTAlertViewStyleKit drawCheckmark];
...
+ (UIImage*)imageOfCross
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [TSTAlertViewStyleKit drawCross];
...
+ (UIImage*)imageOfNotice
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [TSTAlertViewStyleKit drawNotice];
...
+ (UIImage*)imageOfWarning
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [TSTAlertViewStyleKit drawWarning];
...
+ (UIImage*)imageOfQuestion
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [TSTAlertViewStyleKit drawQuestion];
